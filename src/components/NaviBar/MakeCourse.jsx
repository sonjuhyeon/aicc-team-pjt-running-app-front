...
const MakeCourse = () => {
  ...
  return (
    <div className="make-course relative h-[100vh]">
      {/* 헤더 영역 */}
      <div className="absolute top-4 left-0 w-full flex justify-between items-center py-4 px-6 z-10">
        ...
        <div className="w-full flex justify-center">
          <div className="makeCourseHeader relative border rounded-3xl px-6 py-[6px] bg-[#7c5ecf] text-base xs:text-xs  text-white font-bold shadow-2xl">
